...
const ApplicationsList = ({ applicationList, handleCardClick, selectedApplication, handleUpdateDetails, handleDeleteApplication }) => {
  ...
  <div style={{ marginRight: '20px' }}>
    ...
    <input type="text" value={searchCriteria.companyName} onChange={(e) => setSearchCriteria({ ...searchCriteria, companyName: e.target.value })} />
  </div>

  <div style={{ marginRight: '20px' }}>
    <label>Location:</label>
    <input type="text" value={searchCriteria.location} onChange={(e) => setSearchCriteria({ ...searchCriteria, location: e.target.value })} />
  </div>

  <div>
    <label>Status:</label>
    <select value={searchCriteria.status} onChange={(e) => setSearchCriteria({ ...searchCriteria, status: e.target.value })}>
